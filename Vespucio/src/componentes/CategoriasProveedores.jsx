...
const CategoriasProveedores = () => {
    ...
    const[categoriasProveedores,setInsumos]=useState({
        nombre_categoria:'',
    ...
    const{nombre_categoria,descripcion_categoria}=categoriasProveedores;
    ...
    const submit = async()=>{
      try {
        const {error,result}= await supabase.from("categoriasProveedores").insert({
            nombre_categoria,
            descripcion_categoria
        });
    ...
    const{id_categoria}=categoriasProveedores;
